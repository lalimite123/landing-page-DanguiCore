        ...
        >
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`py-2 px-4 rounded-full relative cursor-pointer transition-[background-color_color_box-shadow] duration-300 ease shadow-[0_0_0.5px_1.5px_transparent] text-gray-900 hover:text-blue-600 text-sm font-medium ${
